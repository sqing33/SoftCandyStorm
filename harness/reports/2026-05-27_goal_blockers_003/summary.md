...
| `P1` | `release` | `release_candidate_not_ready` | `release_candidate_not_ready` | `harness/reports/2026-05-27_release_candidate_evidence_current_local_003/release_candidate_evidence.json` |
| `P1` | `release` | `release_package_not_ready` | `release_package_not_ready` | `harness/reports/2026-05-26_release_package_manifest_current_local_004/release_package_manifest.json` |
