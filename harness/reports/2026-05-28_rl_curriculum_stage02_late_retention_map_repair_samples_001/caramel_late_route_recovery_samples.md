...
- Source traces: `8`
- Inspected trace rows: `469`
- Negative route_recovery rows: `50`
- Boundary hotspot rows: `47`
...
- Exported samples: `46`
- Samples: `harness/reports/2026-05-28_rl_curriculum_stage02_late_retention_map_repair_samples_001/caramel_late_route_recovery_samples.jsonl`

## Distributions

- Maps: `{"caramel-workshop": 46}`
- Original actions: `{"1": 3, "3": 15, "5": 12, "7": 5, "8": 11}`
- Target actions: `{"0": 3, "1": 26, "4": 6, "5": 4, "7": 7}`
- Target labels: `{"geometry_inward_non_wallward_action": 21, "highest_scored_non_wallward_action": 25}`
