...
| `P1` | `release` | `release_candidate_not_ready` | `release_candidate_not_ready` | `harness/reports/2026-05-27_release_candidate_evidence_current_local_005/release_candidate_evidence.json` |
| `P1` | `release` | `release_package_not_ready` | `release_package_not_ready` | `harness/reports/2026-05-27_release_package_manifest_current_local_001/release_package_manifest.json` |
| `P2` | `coverage` | `docs_implementation_incomplete` | `docs_implementation_incomplete` | `harness/reports/2026-05-27_docs_implementation_coverage_005/docs_implementation_coverage.json` |
| `P2` | `roadmap` | `roadmap_incomplete` | `roadmap_phase_audit_incomplete` | `harness/reports/2026-05-27_roadmap_phase_audit_005/roadmap_phase_audit.json` |
