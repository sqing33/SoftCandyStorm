...
| `headless_simulation` | `pass` | 4 | False |
| `multi_seed_no_deadlock` | `pass` | 3 | False |
| `content_schema` | `pass` | 2 | False |
| `static_budget` | `pass` | 3 | False |
| `bot_matrix` | `blocked` | 2 | False |
| `replay_regression` | `pass` | 3 | False |
| `performance` | `waiting` | 4 | False |
...
| `failure_case_review` | `pass` | 4 | False |
