...
| `180s` | `soda-creek` | `0.0` | `0.0` | `-0.0647` | `None` | `None` | `None` | `pass` |
...
| `300s` | `soda-creek` | `0.0` | `11.8581` | `-0.0304` | `None` | `None` | `None` | `pass` |
| `60s` | `caramel-workshop` | `0.0` | `0.0111` | `0.0001` | `None` | `None` | `None` | `pass` |
