...
- Content dir: `harness/generated_candidates/2026-06-05_demo_buildcraft_repair_v61_full_pack`
...
- 焦糖旧路环印 (`route-memory-caramel-ring`)：Boss 入场前，糖霜草地会把玩家反复踩回的旧路线凝成焦糖环，提醒玩家换线绕行。
...
- v61 must remain out of content/base_demo and Runtime official content until human gates pass.
