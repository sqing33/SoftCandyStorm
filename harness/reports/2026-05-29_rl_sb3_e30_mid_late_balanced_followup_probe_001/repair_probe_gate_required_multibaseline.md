...
- Window regression (required, `e30`): `harness/reports/2026-05-29_rl_sb3_e30_mid_late_balanced_followup_probe_001/window_regression_vs_e30.json`
- Window regression (required, `parent`): `harness/reports/2026-05-29_rl_sb3_e30_mid_late_balanced_followup_probe_001/window_regression_vs_mid_anchor_parent.json`
- Failure analysis: `harness/reports/2026-05-29_rl_sb3_e30_mid_late_balanced_followup_probe_001/failure_analysis_300s.json`

## Blockers

- parent/window_regression_vs_mid_anchor_parent: 180s/soda-creek: average_survival_seconds dropped 6.857s beyond allowed 5.0s
- parent/window_regression_vs_mid_anchor_parent: 300s/caramel-workshop: average_survival_seconds dropped 5.19s beyond allowed 5.0s
