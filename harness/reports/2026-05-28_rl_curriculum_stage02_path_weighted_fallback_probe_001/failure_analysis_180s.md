...
- Source: `harness/reports/2026-05-28_rl_curriculum_stage02_path_weighted_fallback_probe_001/comparison_180s.json`
...
|---|---:|---:|---:|---|---:|
| `soda-creek` | 0.3333 | 2 | 86.5324 | `8` / 27.58% | 0.7636 |
| `caramel-workshop` | 0.6667 | 1 | 27.9333 | `3` / 32.90% | 0.7269 |
| `cracked-star-jar` | 0.6667 | 1 | 85.0324 | `8` / 33.29% | 0.7614 |
