...
- Negative route_recovery rows: `30`
- Boundary hotspot rows: `29`
- Outside time window rows: `317`
...
- Exported samples: `29`
- Samples: `harness/reports/2026-05-28_rl_curriculum_stage02_current_failure_trace_001/cracked_late_route_recovery_samples.jsonl`

## Distributions

- Maps: `{"cracked-star-jar": 29}`
- Original actions: `{"3": 3, "5": 26}`
- Target actions: `{"1": 25, "5": 3, "7": 1}`
- Target labels: `{"geometry_inward_non_wallward_action": 25, "highest_scored_non_wallward_action": 4}`
