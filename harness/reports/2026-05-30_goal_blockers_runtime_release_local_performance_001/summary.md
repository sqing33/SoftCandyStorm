...
| `P2` | `coverage` | `docs_implementation_incomplete` | `docs_implementation_incomplete` | `harness/reports/2026-05-30_docs_implementation_coverage_runtime_release_local_performance_001/docs_implementation_coverage.json` |
| `P2` | `roadmap` | `roadmap_incomplete` | `roadmap_phase_audit_incomplete` | `harness/reports/2026-05-30_roadmap_phase_audit_runtime_release_local_performance_001/roadmap_phase_audit.json` |
