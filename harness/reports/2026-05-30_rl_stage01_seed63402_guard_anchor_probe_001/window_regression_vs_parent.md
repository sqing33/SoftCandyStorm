...
|---|---|---:|---:|---:|---:|---:|---:|---|
| `180s` | `caramel-workshop` | `0.0` | `5.5892` | `0.0298` | `None` | `None` | `None` | `pass` |
| `180s` | `cracked-star-jar` | `0.0` | `0.0` | `-0.0457` | `None` | `None` | `None` | `pass` |
| `180s` | `soda-creek` | `0.0` | `0.0` | `0.0001` | `None` | `None` | `None` | `pass` |
| `300s` | `caramel-workshop` | `0.0` | `0.0` | `0.0` | `None` | `None` | `None` | `pass` |
| `300s` | `cracked-star-jar` | `0.0` | `0.0` | `0.0` | `None` | `None` | `None` | `pass` |
| `300s` | `soda-creek` | `0.0` | `11.847` | `-0.0301` | `None` | `None` | `None` | `pass` |
