...
| `180s` | `cracked-star-jar` | `0.0` | `0.0` | `0.001` | `None` | `None` | `None` | `pass` |
| `180s` | `soda-creek` | `0.0` | `0.0` | `0.0` | `None` | `None` | `None` | `pass` |
| `300s` | `caramel-workshop` | `0.0` | `0.0` | `0.0` | `None` | `None` | `None` | `pass` |
| `300s` | `cracked-star-jar` | `0.0` | `0.0` | `0.0` | `None` | `None` | `None` | `pass` |
| `300s` | `soda-creek` | `0.0` | `12.4915` | `-0.0375` | `None` | `None` | `None` | `pass` |
| `60s` | `caramel-workshop` | `0.3333` | `6.1999` | `-0.0083` | `None` | `None` | `None` | `pass` |
