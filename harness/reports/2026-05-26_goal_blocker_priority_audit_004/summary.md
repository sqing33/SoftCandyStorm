...
| `P2` | `coverage` | `docs_implementation_incomplete` | `docs_implementation_incomplete` | `harness/reports/2026-05-26_docs_implementation_coverage_024/docs_implementation_coverage.json` |
| `P2` | `roadmap` | `roadmap_incomplete` | `roadmap_phase_audit_incomplete` | `harness/reports/2026-05-26_roadmap_phase_audit_003/roadmap_phase_audit.json` |
