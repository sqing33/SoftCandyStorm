...
- Source: `python/train/rl_policy_acceptance_ppo_target_entropy_warmstart.json`
- Policy: `ppo_target_entropy_warmstart`
- Policy type: `ppo`
...
- training_report_path: `harness/reports/2026-05-27_rl_ppo_target_entropy_warmstart_001/ppo_training_report.json`
- short_eval_report_path: `harness/reports/2026-05-27_rl_ppo_target_entropy_warmstart_multimap_60s_001/comparison.json`
- long_eval_report_path: `harness/reports/2026-05-27_rl_ppo_target_entropy_warmstart_multimap_300s_001/comparison.json`
- rule_bot_comparison_report_path: `harness/reports/2026-05-27_rl_ppo_target_entropy_warmstart_multimap_300s_001/comparison.json`
- local_binary_diagnostic_report_path: `harness/reports/2026-05-27_local_binary_launch_diagnostic_after_terminal_devtools_restart_002/local_binary_launch_diagnostic.json`
...
- short_eval_report.soda-creek: normalized action entropy 0.3189 is below 0.5
- short_eval_report.soda-creek: policy win rate 0.8 is below best rule Bot 1
- short_eval_report.caramel-workshop: normalized action entropy 0.3218 is below 0.5
- short_eval_report.caramel-workshop: policy win rate 0.8 is below best rule Bot 1
- short_eval_report.cracked-star-jar: normalized action entropy 0.3225 is below 0.5
...
- long_eval_report: report still contains 5 finding(s)
- long_eval_report.soda-creek: normalized action entropy 0.2993 is below 0.5
- long_eval_report.soda-creek: policy win rate 0 is below best rule Bot 0.667
- long_eval_report.caramel-workshop: normalized action entropy 0.2276 is below 0.5
- long_eval_report.caramel-workshop: dominant action ratio 0.8237 is above 0.7
- long_eval_report.caramel-workshop: policy win rate 0 is below best rule Bot 0.333
- long_eval_report.cracked-star-jar: normalized action entropy 0.29 is below 0.5
- long_eval_report.cracked-star-jar: dominant action ratio 0.8119 is above 0.7
...
- rule_bot_comparison_report: report still contains 5 finding(s)
- rule_bot_comparison_report.soda-creek: normalized action entropy 0.2993 is below 0.5
- rule_bot_comparison_report.soda-creek: policy win rate 0 is below best rule Bot 0.667
- rule_bot_comparison_report.caramel-workshop: normalized action entropy 0.2276 is below 0.5
- rule_bot_comparison_report.caramel-workshop: dominant action ratio 0.8237 is above 0.7
- rule_bot_comparison_report.caramel-workshop: policy win rate 0 is below best rule Bot 0.333
- rule_bot_comparison_report.cracked-star-jar: normalized action entropy 0.29 is below 0.5
- rule_bot_comparison_report.cracked-star-jar: dominant action ratio 0.8119 is above 0.7
