...
| `manual_playtest` | `waiting` | 9-run manual playtest draft and packet exist, but TODO ratings are not acceptance evidence | 2 |
...
- manual_playtest: 9-run manual playtest draft and packet exist, but TODO ratings are not acceptance evidence
