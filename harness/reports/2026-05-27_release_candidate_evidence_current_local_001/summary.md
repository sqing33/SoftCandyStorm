...
| `headless_simulation` | `pass` | 3 | False |
| `multi_seed_no_deadlock` | `pass` | 2 | False |
| `content_schema` | `pass` | 2 | False |
| `static_budget` | `pass` | 3 | False |
| `bot_matrix` | `pass` | 3 | False |
| `replay_regression` | `pass` | 2 | False |
| `performance` | `waiting` | 3 | False |
...
| `failure_case_review` | `pass` | 3 | False |
