...
- 候选 id：`2026-06-04_demo_buildcraft_repair_v51_full_pack`
- 内容 hash：`fnv1a64:50bd536bd0669e2b`
- 人工试玩报告：`0` / `6`
- 人工试玩草稿仍有 TODO：`True`
...
- 草稿：`harness/content_review/drafts/2026-06-04_demo_buildcraft_repair_v51_full_pack_design_review_draft.json`
...
- 草稿：`harness/playtest/drafts/2026-06-04_demo_buildcraft_repair_v51_manual_playtest_review_draft.json`
...
- 报告路径：`harness/telemetry/local/v51_manual_playtest_new_frosting_jar_keeper.json`
- 本地报告已存在：`False`
- 启动器：`python3 harness/playtest/run_current_manual_playtest.py new_frosting_jar_keeper`
- Runtime 命令：`cargo run -p game_runtime -- --content-dir harness/generated_candidates/2026-06-04_demo_buildcraft_repair_v51_full_pack --character-id jar-keeper --map-id frosting-grassland --seed 55301 --seconds 600 --player-skill new --playtest-report harness/telemetry/local/v51_manual_playtest_new_frosting_jar_keeper.json --capture-interval 2`
...
- 报告路径：`harness/telemetry/local/v51_manual_playtest_speed_soda_bubble_courier.json`
- 本地报告已存在：`False`
- 启动器：`python3 harness/playtest/run_current_manual_playtest.py speed_soda_bubble_courier`
- Runtime 命令：`cargo run -p game_runtime -- --content-dir harness/generated_candidates/2026-06-04_demo_buildcraft_repair_v51_full_pack --character-id bubble-courier --map-id soda-creek --seed 55302 --seconds 600 --player-skill skilled --playtest-report harness/telemetry/local/v51_manual_playtest_speed_soda_bubble_courier.json --capture-interval 2`
...
- 报告路径：`harness/telemetry/local/v51_manual_playtest_summon_cotton_pudding_crafter.json`
- 本地报告已存在：`False`
- 启动器：`python3 harness/playtest/run_current_manual_playtest.py summon_cotton_pudding_crafter`
- Runtime 命令：`cargo run -p game_runtime -- --content-dir harness/generated_candidates/2026-06-04_demo_buildcraft_repair_v51_full_pack --character-id pudding-crafter --map-id cotton-cloud-pasture --seed 55303 --seconds 600 --player-skill build --playtest-report harness/telemetry/local/v51_manual_playtest_summon_cotton_pudding_crafter.json --capture-interval 2`
...
- 报告路径：`harness/telemetry/local/v51_manual_playtest_control_caramel_sour_plum_doctor.json`
- 本地报告已存在：`False`
- 启动器：`python3 harness/playtest/run_current_manual_playtest.py control_caramel_sour_plum_doctor`
- Runtime 命令：`cargo run -p game_runtime -- --content-dir harness/generated_candidates/2026-06-04_demo_buildcraft_repair_v51_full_pack --character-id sour-plum-doctor --map-id caramel-workshop --seed 55304 --seconds 600 --player-skill skilled --playtest-report harness/telemetry/local/v51_manual_playtest_control_caramel_sour_plum_doctor.json --capture-interval 2`
...
- 报告路径：`harness/telemetry/local/v51_manual_playtest_defense_jelly_cream_knight.json`
- 本地报告已存在：`False`
- 启动器：`python3 harness/playtest/run_current_manual_playtest.py defense_jelly_cream_knight`
- Runtime 命令：`cargo run -p game_runtime -- --content-dir harness/generated_candidates/2026-06-04_demo_buildcraft_repair_v51_full_pack --character-id cream-knight --map-id jelly-platform --seed 55305 --seconds 600 --player-skill build --playtest-report harness/telemetry/local/v51_manual_playtest_defense_jelly_cream_knight.json --capture-interval 2`
...
- 报告路径：`harness/telemetry/local/v51_manual_playtest_final_cracked_jar_keeper.json`
- 本地报告已存在：`False`
- 启动器：`python3 harness/playtest/run_current_manual_playtest.py final_cracked_jar_keeper`
- Runtime 命令：`cargo run -p game_runtime -- --content-dir harness/generated_candidates/2026-06-04_demo_buildcraft_repair_v51_full_pack --character-id jar-keeper --map-id cracked-star-jar --seed 55306 --seconds 600 --player-skill skilled --playtest-report harness/telemetry/local/v51_manual_playtest_final_cracked_jar_keeper.json --capture-interval 2`
...
python3 harness/playtest/validate_manual_review.py harness/playtest/drafts/2026-06-04_demo_buildcraft_repair_v51_manual_playtest_review_draft.json --strict-acceptance
