...
Roadmap has 8 incomplete phase(s).
...
| `P1` | `release` | `release_candidate_not_ready` | `release_candidate_not_ready` | `harness/reports/2026-05-30_release_candidate_evidence_runtime_resource_probe_001/release_candidate_evidence.json` |
...
| `P2` | `coverage` | `docs_implementation_incomplete` | `docs_implementation_incomplete` | `harness/reports/2026-05-30_docs_implementation_coverage_runtime_resource_probe_001/docs_implementation_coverage.json` |
| `P2` | `roadmap` | `roadmap_incomplete` | `roadmap_phase_audit_incomplete` | `harness/reports/2026-05-30_roadmap_phase_audit_phase3_bot_harness_completion_001/roadmap_phase_audit.json` |
