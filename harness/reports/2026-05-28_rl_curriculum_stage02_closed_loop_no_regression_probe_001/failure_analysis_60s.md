...
- Source: `harness/reports/2026-05-28_rl_curriculum_stage02_closed_loop_no_regression_probe_001/comparison_60s.json`
...
|---|---:|---:|---:|---|---:|
| `soda-creek` | 0.6667 | 1 | 24.4666 | `2` / 47.72% | 0.4707 |
| `caramel-workshop` | 0.6667 | 1 | 27.9333 | `2` / 71.01% | 0.3758 |
| `cracked-star-jar` | 1.0 | 0 | None | `7` / 60.74% | 0.3049 |
