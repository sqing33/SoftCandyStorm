...
- Source: `python/train/rl_policy_acceptance_staged_gru_context8_phase_aligned.json`
- Policy: `behavior_clone_kite_staged_gru_context8_phase_aligned`
...
- training_report_path: `harness/reports/2026-05-27_rl_behavior_clone_kite_staged_gru_context8_phase_aligned_smoke_001/packaging.json`
- short_eval_report_path: `harness/reports/2026-05-27_rl_behavior_clone_kite_staged_gru_context8_phase_aligned_multimap_60s_001/comparison.json`
- long_eval_report_path: `harness/reports/2026-05-27_rl_behavior_clone_kite_staged_gru_context8_phase_aligned_multimap_300s_001/comparison.json`
- rule_bot_comparison_report_path: `harness/reports/2026-05-27_rl_behavior_clone_kite_staged_gru_context8_phase_aligned_multimap_300s_001/comparison.json`
...
|---|---|---:|---:|---:|---|
| `short_eval_report` | True | 60.0 | 3 | 0.0 | `multimap_comparison_recorded_needs_policy_repair` |
...
- short_eval_report: minimum policy win rate must be >= 1, got `0.0`
- short_eval_report: report gate_decision `multimap_comparison_recorded_needs_policy_repair` still indicates repair/watch
- short_eval_report: report still contains 2 finding(s)
- short_eval_report.soda-creek: normalized action entropy 0.2356 is below 0.5
- short_eval_report.soda-creek: dominant action ratio 0.7911 is above 0.7
- short_eval_report.soda-creek: policy win rate 0 is below best rule Bot 1
...
- long_eval_report.soda-creek: normalized action entropy 0.2894 is below 0.5
- long_eval_report.soda-creek: policy win rate 0 is below best rule Bot 0.667
- long_eval_report.cracked-star-jar: policy win rate 0.3333 is below best rule Bot 1
...
- rule_bot_comparison_report.soda-creek: normalized action entropy 0.2894 is below 0.5
- rule_bot_comparison_report.soda-creek: policy win rate 0 is below best rule Bot 0.667
- rule_bot_comparison_report.cracked-star-jar: policy win rate 0.3333 is below best rule Bot 1
