...
- Pressure filtered rows: `41`
  - Low health risk filtered rows: `0`
  - Hazard pressure filtered rows: `0`
  - Boss pressure filtered rows: `41`
- Missing observation rows: `0`
- Exported samples: `1`
- Samples: `harness/reports/2026-05-28_rl_late_pressure_recovery_samples_001/late_boss_recovery_samples.jsonl`

## Distributions

- Maps: `{"soda-creek": 1}`
- Original actions: `{"4": 1}`
- Target actions: `{"8": 1}`
- Target labels: `{"geometry_inward_non_wallward_action": 1}`
