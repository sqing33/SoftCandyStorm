...
| 1 | Bevy GameCore 原型 | `partial` | 8 | 2 | 0 |
| 2 | Bevy Runtime 可玩版 | `blocked` | 6 | 2 | 1 |
| 3 | 规则 Bot 与 Harness | `partial` | 9 | 2 | 0 |
| 4 | 内容配置化与首批内容 | `partial` | 7 | 3 | 1 |
| 5 | AI 内容生成闭环 | `partial` | 6 | 2 | 1 |
| 6 | AI Bot 训练 | `blocked` | 6 | 3 | 2 |
| 7 | 美术与音频垂直切片 | `partial` | 5 | 2 | 1 |
| 8 | 公开 Demo | `blocked` | 8 | 3 | 2 |
| 9 | 上线前扩展 | `pending` | 6 | 2 | 2 |
