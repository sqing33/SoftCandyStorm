...
- Source: `python/train/rl_policy_acceptance_staged_gru_context8.json`
- Policy: `behavior_clone_kite_staged_gru_context8`
...
- training_report_path: `harness/reports/2026-05-27_rl_behavior_clone_kite_staged_gru_context8_smoke_001/packaging.json`
- short_eval_report_path: `harness/reports/2026-05-27_rl_behavior_clone_kite_staged_gru_context8_multimap_60s_001/comparison.json`
- long_eval_report_path: `harness/reports/2026-05-27_rl_behavior_clone_kite_staged_gru_context8_multimap_300s_001/comparison.json`
- rule_bot_comparison_report_path: `harness/reports/2026-05-27_rl_behavior_clone_kite_staged_gru_context8_multimap_300s_001/comparison.json`
...
|---|---|---:|---:|---:|---|
| `short_eval_report` | True | 60.0 | 3 | 0.2 | `multimap_comparison_recorded_needs_policy_repair` |
...
- short_eval_report: minimum policy win rate must be >= 1, got `0.2`
...
- short_eval_report.soda-creek: normalized action entropy 0.3163 is below 0.5
- short_eval_report.soda-creek: dominant action ratio 0.7672 is above 0.7
- short_eval_report.soda-creek: policy win rate 0.2 is below best rule Bot 1
- short_eval_report.caramel-workshop: normalized action entropy 0.4368 is below 0.5
...
- long_eval_report.soda-creek: normalized action entropy 0.4893 is below 0.5
...
- rule_bot_comparison_report.soda-creek: normalized action entropy 0.4893 is below 0.5
