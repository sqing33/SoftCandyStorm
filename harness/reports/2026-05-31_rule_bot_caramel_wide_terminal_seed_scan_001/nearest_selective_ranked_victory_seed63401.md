...
- Nearest target matches online action ratio: `0.8627`
- Online normalized action entropy: `0.8515`
- Nearest distance average: `2.425806`
...
| `210-240` | `153` | `7` `0.2941` | `1` `0.2026` | `0.8039` | `2.497709` |
...
- step `40` time `1.3333` online `2` conditioned_progress `0.004333` nearest action `2` distance `2.576468` offline_time `265.8567`
- step `45` time `1.5` online `2` conditioned_progress `0.004889` nearest action `2` distance `2.586933` offline_time `265.8567`
- step `50` time `1.6667` online `2` conditioned_progress `0.005444` nearest action `2` distance `2.587688` offline_time `265.8567`
- step `55` time `1.8333` online `2` conditioned_progress `0.006` nearest action `2` distance `2.589717` offline_time `265.8567`
