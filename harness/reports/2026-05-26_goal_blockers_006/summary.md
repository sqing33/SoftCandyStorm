...
| `P1` | `release` | `release_candidate_not_ready` | `release_candidate_not_ready` | `harness/reports/2026-05-26_release_candidate_evidence_current_local_006/release_candidate_evidence.json` |
