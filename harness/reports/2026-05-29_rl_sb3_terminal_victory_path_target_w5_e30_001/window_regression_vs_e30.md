...
| `300s` | `cracked-star-jar` | `0.0` | `14.6006` | `-0.0382` | `0.4315` | `0.0851` | `0.0722` | `pass` |
| `300s` | `soda-creek` | `0.0` | `2.9339` | `0.1056` | `0.59` | `0.2234` | `-0.0696` | `regression` |
...
- 300s/soda-creek: action 1 ratio increased 0.2234 beyond allowed 0.2
