#!/usr/bin/env python3
"""List TODO fields that a human must fill for the current candidate."""
...
from current_candidate import CANDIDATE_ID, CANDIDATE_LABEL, CONTENT_HASH  # noqa: E402
...
def write_markdown(report: dict[str, Any], path: Path) -> None:
    ...
    lines = [
        f"# {report['candidate_label']} Human Evidence TODOs",
        "",
...
def main() -> int:
    parser = argparse.ArgumentParser(description=f"List {CANDIDATE_LABEL} human evidence TODO fields.")
