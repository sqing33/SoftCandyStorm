#!/usr/bin/env python3
"""Regression tests for the current human evidence TODO lister."""
...
LISTER = SCRIPT_DIR / "list_current_human_evidence_todos.py"

sys.path.insert(0, str(SCRIPT_DIR))

from current_candidate import CANDIDATE_ID, CONTENT_HASH, MANUAL_PLAYTEST_RUNS  # noqa: E402
from list_current_human_evidence_todos import DESIGN_DRAFT, PLAYTEST_DRAFT, build_report  # noqa: E402
...
class CurrentHumanEvidenceTodoTests(unittest.TestCase):
    def test_current_drafts_have_human_todos(self) -> None:
        ...
        self.assertEqual(first_run["run_id"], "new_frosting_jar_keeper")
    ...
    def test_cli_allows_current_todos_when_requested(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertIn("# v61 Human Evidence TODOs", summary.read_text(encoding="utf-8"))
